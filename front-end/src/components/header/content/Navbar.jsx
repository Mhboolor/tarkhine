...
function Navbar() {
  ...
  return (
    <nav className="absolute bg-white top-0 right-0 h-screen w-full max-w-[256px] lg:static lg:top-auto lg:right-auto lg:bg-transparent lg:w-auto lg:max-w-none lg:h-auto">
