...
const TarkhineBranchCard = ({ img, branchTitle, branchAddress }) => {
  ...
  return (
    <section
      ...
      className="branch-card h-[80px] md:h-[360px] duration-500 flex w-full border md:hover:shadow-lg transition-all ease-in-out rounded-8 md:flex-col md:gap-2"
    >
      <div className="relative branch-card__img w-[40%] md:w-full md:h-[230px]">
        <div
          className={`absolute h-full w-full transition-all ease-in-out bg-black/40 flex items-center justify-center ${
            isHovered ? "opacity-100" : "opacity-0 "
          }`}
        >
          <div className="absolute cursor-pointer hover:scale-110 transition ease-out">
      ...
      <div className="branch-card__text md:pb-4 gap-4 flex items-center justify-center flex-col w-[60%] md:w-full">
        <div className="flex items-center justify-center flex-col">
          ...
          <p className="text-center text-caption-sm md:text-caption-lg mb-2">
            {branchAddress}
          </p>
